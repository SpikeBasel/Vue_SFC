  ...
  <div>
    <section class="d-flex justify-content-center ">
      ...
      <div class="row justify-content-center">
        <div v-for="lesson in lessons" :key="lesson._id" class="d-flex justify-content-center" >
          <div class="card set-border" style="width: 28rem;">
            <div class="card-body">
              <h5 class="card-title">
                <div class="row">
                  <div class="col">
              ...
              <div class="d-flex justify-content-center">
                <button class="btn btn-lg btn-success mx-2" v-on:click="$emit('addLesson', lesson)" v-bind:disabled="lesson.space <= 0">
                  Add to cart
                </button>
              </div>
            </div>
